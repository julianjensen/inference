...
const SymbolFlags1 = {
    All: {
        get: () => SymbolFlags.FunctionScopedVariable | SymbolFlags.BlockScopedVariable | SymbolFlags.Property | SymbolFlags.EnumMember | SymbolFlags.Function |
    ...
    Enum:      { get: () => SymbolFlags.RegularEnum | SymbolFlags.ConstEnum },
    Variable:  { get: () => SymbolFlags.FunctionScopedVariable | SymbolFlags.BlockScopedVariable },
    Value:     {
        get: () => SymbolFlags.Variable | SymbolFlags.Property | SymbolFlags.EnumMember | SymbolFlags.Function | SymbolFlags.Class | SymbolFlags.Enum | SymbolFlags.ValueModule |
                   SymbolFlags.Method | SymbolFlags.GetAccessor | SymbolFlags.SetAccessor
    },
    Type:      {
        get: () => SymbolFlags.Class | SymbolFlags.Interface | SymbolFlags1.Enum | SymbolFlags.EnumMember | SymbolFlags.TypeLiteral | SymbolFlags.ObjectLiteral |
                   SymbolFlags.TypeParameter | SymbolFlags.TypeAlias
    },
    Namespace: { get: () => SymbolFlags.ValueModule | SymbolFlags.NamespaceModule | SymbolFlags.Enum },
    Module:    { get: () => SymbolFlags.ValueModule | SymbolFlags.NamespaceModule },
    Accessor:  { get: () => SymbolFlags.GetAccessor | SymbolFlags.SetAccessor },

    // Variables can be redeclared, but can not redeclare a block-scoped declaration with the
    // same name, or any other value that is not a variable, e.g. ValueModule or Class
    FunctionScopedVariableExcludes: { get: () => SymbolFlags.Value & ~SymbolFlags.FunctionScopedVariable },

    // Block-scoped declarations are not allowed to be re-declared
    // they can not merge with anything in the value space
    BlockScopedVariableExcludes: { get: () => SymbolFlags.Value },

    ParameterExcludes:       { get: () => SymbolFlags.Value },
    PropertyExcludes:        { get: () => SymbolFlags.None },
    EnumMemberExcludes:      { get: () => SymbolFlags.Value | SymbolFlags.Type },
    FunctionExcludes:        { get: () => SymbolFlags.Value & ~( SymbolFlags.Function | SymbolFlags.ValueModule ) },
    ClassExcludes:           { get: () => ( SymbolFlags.Value | SymbolFlags.Type ) & ~( SymbolFlags.ValueModule | SymbolFlags.Interface ) }, // class-interface mergability done in checker.ts
    InterfaceExcludes:       { get: () => SymbolFlags.Type & ~( SymbolFlags.Interface | SymbolFlags.Class ) },
    RegularEnumExcludes:     { get: () => ( SymbolFlags.Value | SymbolFlags.Type ) & ~( SymbolFlags.RegularEnum | SymbolFlags.ValueModule ) }, // regular enums merge only with regular enums and modules
    ConstEnumExcludes:       { get: () => ( SymbolFlags.Value | SymbolFlags.Type ) & ~SymbolFlags.ConstEnum }, // const enums merge only with const enums
    ValueModuleExcludes:     { get: () => SymbolFlags.Value & ~( SymbolFlags.Function | SymbolFlags.Class | SymbolFlags.RegularEnum | SymbolFlags.ValueModule ) },
    NamespaceModuleExcludes: { get: () => 0 },
    MethodExcludes:          { get: () => SymbolFlags.Value & ~SymbolFlags.Method },
    GetAccessorExcludes:     { get: () => SymbolFlags.Value & ~SymbolFlags.SetAccessor },
    SetAccessorExcludes:     { get: () => SymbolFlags.Value & ~SymbolFlags.GetAccessor },
    TypeParameterExcludes:   { get: () => SymbolFlags.Type & ~SymbolFlags.TypeParameter },
    TypeAliasExcludes:       { get: () => SymbolFlags.Type },
    AliasExcludes:           { get: () => SymbolFlags.Alias },

    ModuleMember: {
        get: () => SymbolFlags.Variable | SymbolFlags.Function | SymbolFlags.Class | SymbolFlags.Interface | SymbolFlags.Enum | SymbolFlags.Module |
                   SymbolFlags.TypeAlias | SymbolFlags.Alias
    },

    ExportHasLocal: { get: () => SymbolFlags.Function | SymbolFlags.Class | SymbolFlags.Enum | SymbolFlags.ValueModule },

    HasExports: { get: () => SymbolFlags.Class | SymbolFlags.Enum | SymbolFlags.Module },
    HasMembers: { get: () => SymbolFlags.Class | SymbolFlags.Interface | SymbolFlags.TypeLiteral | SymbolFlags.ObjectLiteral },

    BlockScoped: { get: () => SymbolFlags.BlockScopedVariable | SymbolFlags.Class | SymbolFlags.Enum },

    PropertyOrAccessor: { get: () => SymbolFlags.Property | SymbolFlags.Accessor },

    ClassMember: { get: () => SymbolFlags.Method | SymbolFlags.Accessor | SymbolFlags.Property },

    // The set of things we consider semantically classifiable.  Used to speed up the LS during
    // classification.
    Classifiable: { get: () => SymbolFlags.Class | SymbolFlags.Enum | SymbolFlags.TypeAlias | SymbolFlags.Interface | SymbolFlags.TypeParameter | SymbolFlags.Module | SymbolFlags.Alias },

    LateBindingContainer: { get: () => SymbolFlags.Class | SymbolFlags.Interface | SymbolFlags.TypeLiteral | SymbolFlags.ObjectLiteral }
};
 ...
 * @name SymbolFlags
 */
SymbolFlags = make_extra( SymbolFlags0, SymbolFlags1 );
export { SymbolFlags };
